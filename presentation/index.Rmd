...
- Implement 4 common technical analysis index: **Simple Moving Average**, **Weighted Moving Average**, **Exponential Moving Average** and **Bollinger Bands**
- Integrate with Highchart: a popular open source charting library for financial data
- Display calaulation results on Chart

## Why Use HighChart

- Good support in **OHLC Chart**
- Can integrate with rChart
